...
public class CALang {
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(CreateArcanus.ID + "." + key, resolveBuilders(args));
    }
    public static MutableComponent translateRune(String key, Object... args) {
    ...
    public static LangBuilder builder() {
        return new LangBuilder(CreateArcanus.ID);
    }
    ...
    public static LangBuilder translateDescriptionID(String langKey, Object... args) {
        return builder().add(Components.translatable(langKey, Lang.resolveBuilders(args)));
    }
