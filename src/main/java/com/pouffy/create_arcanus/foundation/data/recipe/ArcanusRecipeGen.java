...
public abstract class ArcanusRecipeGen  extends CreateRecipeProvider {

    protected static final List<ArcanusRecipeGen> GENERATORS = new ArrayList<>();
    ...
    public static void registerAll(DataGenerator gen) {
        GENERATORS.add(new ArcaneConversionRecipeGen(gen));
        gen.addProvider(new DataProvider() {

            @Override
            public String getName() {
                return "Create Arcanus' Processing Recipes";
            }
    ...
    public ArcanusRecipeGen(DataGenerator generator) {
        super(generator);
    }
    ...
    <T extends ProcessingRecipe<?>> GeneratedRecipe create(Supplier<ItemLike> singleIngredient,
        ...
        return create(CreateArcanus.MODID, singleIngredient, transform);
    }
    ...
    <T extends ProcessingRecipe<?>> GeneratedRecipe create(String name,
                                                           UnaryOperator<ProcessingRecipeBuilder<T>> transform) {
        return create(CreateArcanus.asResource(name), transform);
    }
    ...
    protected Supplier<ResourceLocation> idWithSuffix(Supplier<ItemLike> item, String suffix) {
        return () -> {
            ResourceLocation registryName = RegisteredObjects.getKeyOrThrow(item.get()
                    .asItem());
            return CreateArcanus.asResource(registryName.getPath() + suffix);
        };
    }
