package com.pouffy.create_arcanus.foundation.data;
...
import com.pouffy.create_arcanus.foundation.utility.RegisteredObjects;
...
public class BuilderTransformers {
    public static <B extends ArcanusEncasedShaftBlock, P> NonNullUnaryOperator<BlockBuilder<B, P>> encasedShaft(String casing,
        ...
        return builder -> encasedBase(builder, AllBlocks.SHAFT::get)
                ...
                .onRegister(casingConnectivity((block, cc) -> cc.make(block, casingShift.get(),
                        (s, f) -> f.getAxis() != s.getValue(ArcanusEncasedShaftBlock.AXIS))))
    ...
    public static <B extends EncasedCogwheelBlock, P> NonNullUnaryOperator<BlockBuilder<B, P>> encasedLargeCogwheel(
        ...
        return b -> encasedCogwheelBase(b, casing, casingShift, AllBlocks.LARGE_COGWHEEL::get, true)
                .onRegister(connectedTextures(() -> new EncasedCogCTBehaviour(casingShift.get())));
    }
        ...
        return encasedBase(b, drop).addLayer(() -> RenderType::cutoutMipped)
                ...
                .blockstate((c, p) -> axisBlock(c, p, blockState -> {
                    ...
                    return p.models()
                            ...
                            .texture("casing", CreateArcanus.asResource("block/" + casing + "_casing"))
                            .texture("1", new ResourceLocation("block/stripped_" + wood + "_log_top"))
                            .texture("side", CreateArcanus.asResource("block/" + casing + encasedSuffix));
                }, false))
                .item()
        ...
        return b -> b.initialProperties(() -> Blocks.LADDER)
                ...
                .recipe((c, p) -> {
                    if (name.equals("andesite"))
                        return;
                    p.stonecutting(ingredient.get(), c, 2);
                })
                .model((c, p) -> p.blockSprite(c, p.modLoc("block/ladder_" + name)))
                .build();
    }
    ...
    public static <B extends ArcanusCasingBlock> NonNullUnaryOperator<BlockBuilder<B, CreateRegistrate>> casing(
    ...
    public static <B extends ArcanusCasingBlock> NonNullUnaryOperator<BlockBuilder<B, CreateRegistrate>> layeredCasing(
                ...
                .blockstate((c, p) -> p.getVariantBuilder(c.get())
                        .forAllStates(state -> {
                            ...
                            return ConfiguredModel.builder()
                                    ...
                                    .rotationY(state.getValue(BeltTunnelBlock.HORIZONTAL_AXIS) == Direction.Axis.X ? 0 : 90)
                                    .build();
                        }))
    ...
    public static <B extends Block, P> NonNullUnaryOperator<BlockBuilder<B, P>> bearing(String prefix,
        ...
        ResourceLocation baseBlockModelLocation = CreateArcanus.asResource("block/bearing/block");
        ResourceLocation baseItemModelLocation = CreateArcanus.asResource("block/bearing/item");
        ResourceLocation topTextureLocation = CreateArcanus.asResource("block/bearing_top" + (woodenTop ? "_wooden" : ""));
        ResourceLocation nookTextureLocation =
                CreateArcanus.asResource("block/" + (woodenTop ? "andesite" : "brass") + "_casing");
        ResourceLocation sideTextureLocation = CreateArcanus.asResource("block/" + prefix + "_bearing_side");
        ResourceLocation backTextureLocation = CreateArcanus.asResource("block/" + backTexture);
        return b -> b.initialProperties(SharedProperties::stone)
                .properties(BlockBehaviour.Properties::noOcclusion)
